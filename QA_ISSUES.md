...
| 编号 | 修复时间 | 验证结果 |
|------|----------|----------|
| Q008 | 2026-02-22 | ✅ 已删除重复TaskController |
| Q014 | 2026-02-22 | ✅ 已删除重复UserController |
| Q018 | 2026-02-22 | ✅ MomentController已创建 |
| Q019 | 2026-02-22 | ✅ ScheduleController已创建 |

## 新增问题

| 编号 | 类型 | 位置 | 描述 | 优先级 |
|------|------|------|------|--------|
| Q023 | 编译错误 | CacheAspect.java | Lombok @Slf4j未生效，找不到log变量 | P0 |
| Q024 | 接口不一致 | ScheduleController | 后端接口与前端不匹配(list参数/today接口) | P1 |
| Q025 | 接口缺失 | task-service | 缺少子任务/重复规则/提醒接口 | P1 |
