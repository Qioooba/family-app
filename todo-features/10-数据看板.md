...
// 获取本周数据
GET /api/dashboard/week?userId=123
Response: {
  "taskCompletion": [80, 90, 75, 100, 85, 90, 95],
  "dietTrend": [{"date": "周一", "calories": 1800}, ...],
  "weightTrend": [{"date": "周一", "weight": 65.5}, ...]
}
...
CREATE TABLE dashboard_stats (
    ...
    UNIQUE KEY uk_user_type_date (user_id, stat_type, stat_date)
);
...
CREATE TABLE year_memories (
    ...
    family_id BIGINT,
    year INT COMMENT '年份',
    memory_type VARCHAR(50) COMMENT '回忆类型',
    content TEXT COMMENT '回忆内容',
    media_urls JSON COMMENT '相关图片/视频',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP
);
```
