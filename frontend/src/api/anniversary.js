 ...
 * BasePath: /api/calendar/anniversary
 */
export const anniversaryApi = {
   ...
   */
  getList: (familyId) => request.get(`/api/calendar/anniversary/list/${familyId}`),
   ...
   */
  getUpcoming: (familyId, days = 30) => request.get(`/api/calendar/anniversary/upcoming/${familyId}`, { days }),
   ...
   */
  getToday: (familyId) => request.get(`/api/calendar/anniversary/today/${familyId}`),
