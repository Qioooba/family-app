...
export const scheduleApi = {
   ...
   */
  getList: (familyId) => request.get(`/api/schedule/list/${familyId}`),
   ...
   */
  getToday: (familyId) => request.get(`/api/schedule/today/${familyId}`),
   ...
   */
  delete: (id) => request.delete(`/api/schedule/${id}`)
}
